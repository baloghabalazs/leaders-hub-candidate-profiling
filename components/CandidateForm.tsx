    ...
    const exampleProfiles = [
      {
        ...
        residence: 'Budapest',
        traits: ['ambitious', 'communicative', 'goal_oriented', 'confident'],
        motivation: Motivation.FREEDOM,
      ...
      },
      {
        ...
        residence: 'Debrecen',
        traits: ['positive', 'caring', 'team_player', 'flexible'],
      ...
      },
      {
        ...
        occupation: 'Tanár',
        residence: 'Szeged',
        traits: ['caring', 'cautious', 'analytical', 'employee'],
      ...
      },
      {
        ...
        residence: 'Győr',
        traits: ['creative', 'ambitious', 'impulsive', 'open'],
        motivation: Motivation.FREEDOM,
        timeAvailability: TimeFrame.T10_PLUS,
        salesExperience: true,
        discType: 'D',
      ...
      },
      {
        ...
        residence: 'Pécs',
        traits: ['confident', 'team_player', 'persistent', 'communicative'],
      ...
      },
      {
        ...
        residence: 'Miskolc',
        traits: ['open', 'flexible', 'creative', 'cautious'],
        motivation: Motivation.MONEY,
        timeAvailability: TimeFrame.T10_PLUS,
        salesExperience: false,
        discType: 'S',
